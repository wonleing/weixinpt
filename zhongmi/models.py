...
class ZhongmiCustomer(models.Model):
    ...
    age = models.CharField('年龄', max_length=10L, blank=True)
    address = models.CharField('地址', max_length=200L, blank=True)
...
class ZhongmiSales(models.Model):
    ...
    def __unicode__(self):
        return str(self.salesid) + " - " + str(self.date)
...
class ZhongmiSalesdetail(models.Model):
    ...
    def __unicode__(self):
        return str(self.detailid) + " - " + str(self.salesid)
...
class ZhongmiShops(models.Model):
    ...
    def __unicode__(self):
        return str(self.grade) + " - " + self.description
